...
function calcularPeso(){
  ...
  var peso = document.getElementById("peso").value * 4.44;
    //alert(peso);
  //peso = peso * 4.44;
  var masa = peso / 9.8;

  var pesoLuna = (masa * 1.6) / 4.44;

  //pesoLuna = pesoLuna / 4.44;

  //alert("Su Peso en la Luna: " + pesoLuna + " lbs");

  document.getElementById("pesoLuna").value = pesoLuna + " lbs";
